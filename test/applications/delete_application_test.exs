defmodule Nexmo.Account.DeleteApplicationTest do
  use ExUnit.Case
  ...
  test "sends valid request to Nexmo", %{
    ...
    Bypass.expect bypass, fn conn ->
      assert "/123a-456b-789c-12345d" == conn.request_path
      assert "DELETE" == conn.method
      Plug.Conn.send_resp(conn, 200, Poison.encode!(valid_response))
    end
    response = Nexmo.Applications.delete(application_id: "123a-456b-789c-12345d")
