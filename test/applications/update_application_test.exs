defmodule Nexmo.Applications.UpdateApplicationTest do
  use ExUnit.Case
  ...
  test "sends valid request to Nexmo", %{
    ...
    Bypass.expect bypass, fn conn ->
      assert "/78d335fa323d01149c3dd6f0d48968cf" == conn.request_path
      assert "POST" == conn.method
      Plug.Conn.send_resp(conn, 200, Poison.encode!(valid_response))
    end
    response = Nexmo.Applications.update(
      application_id: "78d335fa323d01149c3dd6f0d48968cf",
      answer_method: "POST"
      )
